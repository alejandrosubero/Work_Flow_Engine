...
@Service
public class MailSenderValidation {

    public MailSenderPojo valida(MailSenderPojo mailsender) {
        MailSenderPojo pojo = null;
        try {
            if (mailsender != null) {
                if (mailsender.getPort() != null
                        && mailsender.getTemplate() != null
                        && mailsender.getActive() != null
                        && mailsender.getWasSend() != null
                        && mailsender.getEmail() != null) {
                    pojo = mailsender;
                }
            }
            return pojo;
